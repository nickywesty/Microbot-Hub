...
public class WildernessAgilityWithPKOverlay extends OverlayPanel {
    private boolean active = false;
    private WildernessAgilityWithPKScript script;

    @Inject
    public WildernessAgilityWithPKOverlay(WildernessAgilityWithPKPlugin plugin) {
        super(plugin);
    ...
    public void setScript(WildernessAgilityWithPKScript script) {
        this.script = script;
    }
